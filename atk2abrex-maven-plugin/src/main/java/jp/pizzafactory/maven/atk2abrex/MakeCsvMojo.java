...
/**
 */
@Mojo(name = "make-csv", defaultPhase = LifecyclePhase.PROCESS_SOURCES)
public class MakeCsvMojo extends AbstractAtk2AbrexMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        container.callMethod(context, "MakeCsv", sOutputDir, sFileName,
                targetModule);
        container.terminate();
    }
